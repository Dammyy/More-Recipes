...
module.exports = {
  test(browser) {
    browser
      ...
      .click('.btn-favorited')
      .pause(2000)
      .click('#btn-my-favorites')
      .pause(2000)
      .click('#btn-my-profile')
      .pause(2000)
      .click('#btn-home')
      .pause(2000)
      .click('.welcome-msg .home-logged-in #btn-logout')
      .pause(2000)
      .click('.welcome-msg .home-logged-in a#btn-login')
      .pause(2000)
      .setValue('#email', email)
      .pause(1000)
      .setValue('#password', password)
      ...
      .click('button[type=submit]')
      .pause(1000)
      .click('.welcome-msg .home-logged-in #btn-browse')
      .pause(4000)
      .click('#btn-home')
      .pause(2000)
      .end();
